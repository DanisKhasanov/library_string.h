...
const char *s21_width_parser(my_sprintf *flags, const char *format, va_list vl);
...
void s21_specifier_c(my_sprintf *flags, va_list vl, char *curernt_simb);
void s21_specifier_d(my_sprintf *flags, va_list vl, char *curernt_simb);
void s21_specifier_f(my_sprintf *flags, va_list vl, char *current_simb);
void s21_specifier_s(my_sprintf *flags, va_list vl, char *curernt_simb);
